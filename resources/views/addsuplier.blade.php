...
<body class="bg-gray-100 min-h-screen flex items-center justify-center p-6">
    ...
    <form action="{{ route('add-supplier') }}" method="POST"
        ...
        <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">اضافه مورد جديد</h2>
        <div>
            <label for="name" class="block text-gray-700 font-medium mb-2">اسم</label>
